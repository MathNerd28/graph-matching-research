...
public class IntHashSet extends AbstractSet<Integer> {
    ...
    /**
     * The hash table. The array indexes are the hashes, and the array values
    ...
    /**
     * Initialize the hash table with the specified capacity, and clear it of
     * all entries.
     *
     * @param capacity
    ...
    /**
     * Reallocate {@link #table} and supporting structure with a new capacity,
     * and re-insert all existing entries. All values that were previously
     * present in this set will still be present after this operation, but not
     * necessarily in the same location. No cells will be marked 'deleted' after
     * this operation.
     *
     * @param capacity
     ...
     * @implNote This function is a bijection and easily reversible, and
     *     therefore vulnerable against maliciously-constructed data.
     */
     ...
     *     the integer to hash
     * @return the hash of that integer
     * @implSpec The hash table size is always a power of 2; since the outputs
     *     of this function must be coprime with all powers of 2, this function
     *     must always return an odd integer.
