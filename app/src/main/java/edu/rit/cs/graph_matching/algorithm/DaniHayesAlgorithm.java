 ...
 */
public class DaniHayesAlgorithm implements MatchingAlgorithm {
    /** The input graph */
    ...
    /**
     * Generates a matching with the specified number of edges. This method is
     * not guaranteed to ever return without being interrupted.
     *
     * @param edgeCount
     ...
     * only to allow interruption of the algorithm by the user for the purpose
     * of e.g. timeouts.
     *
